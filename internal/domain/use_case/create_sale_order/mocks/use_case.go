...
func (mr *MocknumberGeneratorMockRecorder) GenerateNumber(date, company interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MocksaleOrderServiceMockRecorder) CreateOrder(ctx, order interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
